...
weight: 20
description: "What coaching actually is, how it differs from training and mentoring, and the GROW model for running a conversation that ends in the other person's plan."
lastUpdated: 2026-06-25
goDeeper:
  - group: Books
    title: "The Coaching Habit — Michael Bungay Stanier"
    url: "https://boxofcrayons.com/the-coaching-habit-book/"
    why: "Say less, ask more. Seven questions that turn you from advice-giver into coach — the most practical coaching book I know."
  - group: Courses
    title: "Coaching Skills for Leaders and Managers — Sara Canaday"
    url: "https://www.linkedin.com/learning/coaching-skills-for-leaders-and-managers"
    why: "The LinkedIn Learning course this page draws much of its structure from, including the GROW walkthrough."
  - group: Books
    title: "Co-Active Coaching — Kimsey-House et al."
    url: "https://coactive.com/books/co-active-coaching/"
    why: "The foundational text on coaching as a relationship built on listening and discovery, not on having the answers."
---
...
1. **Discovery** — start from genuine curiosity, not a conclusion you've already reached.
2. **Their perspective** — get the situation as *they* see it, not as you assume it.
3. **Current vs. ideal** — name the gap between where things are and where they want them to be.
4. **Solution discovery** — let them generate the options.
5. **Action plan** — turn it into something concrete they own.
6. **Follow-up and support** — come back to it; otherwise it was just a nice chat.
...
- **G**oal
- **R**eality (the current situation)
- **O**ptions
- **W**ill (the way forward)
...
{{< protip >}}
When you catch yourself about to hand over the answer, ask "And what else?" instead. It's the single best coaching question I know — the first answer is rarely the real one, and that little prompt keeps the thinking on their side of the table. (Straight out of *The Coaching Habit*.)
{{< /protip >}}
...
- [Coaching Skills for Leaders and Managers](https://www.linkedin.com/learning/coaching-skills-for-leaders-and-managers) by [Sara Canaday](https://saracanaday.com) — LinkedIn Learning; much of this page's structure comes from here.
- [The Coaching Habit](https://www.amazon.com/Coaching-Habit-Less-Change-Forever/dp/0978440749) by Michael Bungay Stanier.

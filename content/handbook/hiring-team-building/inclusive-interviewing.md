...
weight: 10
description: "Applying inclusion principles — access, fair signals, and reducing bias — to the interview itself, so the people you hire reflect the team you actually want to build."
...
- [A Manager's Guide to Inclusive Teams](https://www.linkedin.com/learning/a-manager-s-guide-to-inclusive-teams) — LinkedIn Learning; the inclusion principles this page applies to interviewing.
- [What Google Learned From Its Quest to Build the Perfect Team](https://www.nytimes.com/2016/02/28/magazine/what-google-learned-from-its-quest-to-build-the-perfect-team.html) — why psychological safety and belonging are worth hiring for in the first place.
